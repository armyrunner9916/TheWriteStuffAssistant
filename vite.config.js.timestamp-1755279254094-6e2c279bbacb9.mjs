...
var vite_config_default = defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      "ws": path2.resolve(__vite_injected_original_dirname, "./src/stubs/ws-stub.js")
    }
  },
  build: {
    rollupOptions: {
