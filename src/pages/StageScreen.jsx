...
function StageScreen({ onLogout }) {
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.download = `stage-screen-conversation-${new Date().toISOString().split('T')[0]}.txt`;
        ...
        <div className="w-full max-w-5xl lg:max-w-6xl xl:max-w-7xl">
          <header className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 lg:mb-8">
            <div className="flex gap-2 flex-wrap justify-center sm:justify-start">
               ...
               <Button onClick={() => navigate(`/stage/history`)} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400 lg:h-10 lg:px-4 lg:text-base">
          ...
          <p className="text-center text-yellow-400/80 mb-8 lg:mb-10 lg:text-lg xl:text-xl">Your all-in-one tool for crafting compelling scripts.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 lg:gap-10">
            <Card className="bg-zinc-900/50 border-yellow-400/30">
              <CardHeader className="lg:p-8">
                <CardTitle className="text-yellow-400 text-2xl lg:text-3xl xl:text-4xl">Develop Your Script</CardTitle>
              </CardHeader>
