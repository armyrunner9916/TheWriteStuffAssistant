...
const QUERY_TYPE = "poetry_style_voice";
const QUERY_TYPE_LABEL = "Style & Voice Feedback";

function PoetryStyleVoice({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/poetry-style-voice`} />
      </Helmet>
...
export default PoetryStyleVoice;