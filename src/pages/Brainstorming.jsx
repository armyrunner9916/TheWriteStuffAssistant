...
const QUERY_TYPE = "brainstorming";
const QUERY_TYPE_LABEL = "Brainstorming";
const UNIFIED_PROMPT_QUERY_TYPE = "fictional_prose_unified";

function Brainstorming({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/brainstorming`} />
      </Helmet>
