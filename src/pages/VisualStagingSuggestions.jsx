...
const QUERY_TYPE = "visual_staging_suggestions";
const QUERY_TYPE_LABEL = "Visual & Staging Suggestions";

function VisualStagingSuggestions({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/visual-staging-suggestions`} />
      </Helmet>
        ...
        <header className="p-4 bg-black flex flex-col items-center gap-4 sticky top-0 z-10 border-b border-yellow-400/30">
          <div className="flex gap-2 flex-wrap justify-center items-center">
            <Button onClick={() => navigate('/stage-screen')} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400">
              <ArrowLeft className="h-4 w-4 mr-1" /> Back to Stage & Screen Tools
            </Button>
...
export default VisualStagingSuggestions;