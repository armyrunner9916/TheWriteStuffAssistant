...
function Prose({ onLogout }) {
  ...
  const handleDownload = () => {
    ...
    link.href = url;
    link.download = `prose-conversation-${new Date().toISOString().split('T')[0]}.txt`;
        ...
        <div className="w-full max-w-5xl lg:max-w-6xl xl:max-w-7xl">
          <header className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 lg:mb-8">
            <div className="flex gap-2 flex-wrap justify-center sm:justify-start">
               ...
               <Button onClick={() => navigate(`/prose/history`)} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400 lg:h-10 lg:px-4 lg:text-base">
