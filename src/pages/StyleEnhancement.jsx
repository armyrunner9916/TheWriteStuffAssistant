...
const QUERY_TYPE = "style_enhancement";
const QUERY_TYPE_LABEL = "Style Enhancement";
const UNIFIED_PROMPT_QUERY_TYPE = "fictional_prose_unified";

function StyleEnhancement({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        <title>{QUERY_TYPE_LABEL} | Fictional Prose | The Write Stuff Assistant</title>
        <meta name="description" content={`AI-powered assistant for ${QUERY_TYPE_LABEL}.`} />
        <link rel="canonical" href={`https://writestuffassistant.com/style-enhancement`} />
      </Helmet>
...
export default StyleEnhancement;