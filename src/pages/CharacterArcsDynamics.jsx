...
const QUERY_TYPE = "character_arcs_dynamics";
const QUERY_TYPE_LABEL = "Character Arcs & Dynamics";

function CharacterArcsDynamics({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/character-arcs-dynamics`} />
      </Helmet>
...
export default CharacterArcsDynamics;