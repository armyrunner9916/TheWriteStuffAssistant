...
const QUERY_TYPE = "story_outline";
const QUERY_TYPE_LABEL = "Story Outline";
const UNIFIED_PROMPT_QUERY_TYPE = "fictional_prose_unified";

function StoryOutline({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/story-outline`} />
      </Helmet>
