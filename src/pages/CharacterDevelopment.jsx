...
const QUERY_TYPE = "character_development";
const QUERY_TYPE_LABEL = "Character Development";
const UNIFIED_PROMPT_QUERY_TYPE = "fictional_prose_unified";

function CharacterDevelopment({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        <title>Character Development Tool | Fictional Prose | The Write Stuff Assistant</title>
        <meta name="description" content="Develop memorable characters. Use our character development tool to build backstories, motivations and arcs for engaging narratives." />
        <link rel="canonical" href="https://writestuffassistant.com/character-development" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Character Development Tool | Fictional Prose | The Write Stuff Assistant" />
        <meta property="og:description" content="Develop memorable characters. Use our character development tool to build backstories, motivations and arcs for engaging narratives." />
        <meta property="og:image" content="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=1964&auto=format&fit=crop" />
        <meta property="og:image:alt" content="Silhouette of a person with thought bubbles symbolizing character development" />
      </Helmet>
        ...
        <header className="p-4 bg-black flex flex-col items-center gap-4 sticky top-0 z-10 border-b border-yellow-400/30">
          <div className="flex gap-2 flex-wrap justify-center items-center">
            <Button onClick={() => navigate('/prose')} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400">
              <ArrowLeft className="h-4 w-4 mr-1" /> Back to Prose
            </Button>
