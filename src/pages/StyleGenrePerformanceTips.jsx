import React, { useState, useEffect } from "react";
    ...
    const QUERY_TYPE = "style_genre_performance_tips";
    const QUERY_TYPE_LABEL = "Style, Genre & Performance Tips";

    function StyleGenrePerformanceTips() {
      ...
      const handlePromptSubmit = async (promptText, file) => {
        ...
        try {
          ...
          toast({ title: "AI Response", description: "Performance tips generated." });
        } catch (error) {
          console.error("API Error:", error);
          toast({ title: "Error", description: error.message || "Failed to get tips from AI.", variant: "destructive" });
        } finally {
          setIsLoading(false);
          setUploadedFile(null);
        }
      ...
      return (
        <>
        <Helmet>
            <title>Style, Genre & Performance Tips | The Write Stuff Assistant</title>
            <meta name="description" content="Refine your song's style, genre, and performance. Get AI-powered tips on vocal delivery, musical arrangement, and stage presence to perfect your sound." />
            <link rel="canonical" href="https://writestuffassistant.com/style-genre-performance-tips" />
            <meta property="og:type" content="article" />
            <meta property="og:title" content="Style, Genre & Performance Tips | The Write Stuff Assistant" />
            <meta property="og:description" content="Refine your song's style, genre, and performance. Get AI-powered tips on vocal delivery, musical arrangement, and stage presence to perfect your sound." />
            <meta property="og:url" content="https://writestuffassistant.com/style-genre-performance-tips" />
            <meta property="og:image" content="https://images.unsplash.com/photo-1524230659267-399233de5e26?q=80&w=2070&auto=format&fit=crop" />
            <meta property="og:image:alt" content="A microphone on a stage, representing style, genre, and performance tips." />
        </Helmet>
    ...
    export default StyleGenrePerformanceTips;