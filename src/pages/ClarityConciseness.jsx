...
const QUERY_TYPE = "clarity_conciseness";
const QUERY_TYPE_LABEL = "Clarity & Conciseness";

function ClarityConciseness({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/clarity-conciseness`} />
      </Helmet>
...
export default ClarityConciseness;