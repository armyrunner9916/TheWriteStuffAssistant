...
const QUERY_TYPE = "poetry_revision_clarity";
const QUERY_TYPE_LABEL = "Revision & Clarity Coach";

function PoetryRevisionClarity({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/poetry-revision-clarity`} />
      </Helmet>
...
export default PoetryRevisionClarity;