import React, { useState, useEffect } from "react";
    ...
    const QUERY_TYPE = "melody_hook_creation";
    const QUERY_TYPE_LABEL = "Melody & Hook Creation";

    function MelodyHookCreation() {
      ...
      const handlePromptSubmit = async (promptText, file) => {
        ...
        try {
          ...
          toast({ title: "AI Response", description: "Melody/hook suggestions generated." });
        } catch (error) {
      ...
      return (
        <>
        <Helmet>
            <title>Melody & Hook Creation Tool | Songwriting | The Write Stuff Assistant</title>
            <meta name="description" content="Create catchy melodies and unforgettable hooks. Our AI tool helps you explore melodic ideas, rhythms, and structures to make your songs stand out." />
            <link rel="canonical" href="https://writestuffassistant.com/melody-hook-creation" />
            <meta property="og:type" content="article" />
            <meta property="og:title" content="Melody & Hook Creation Tool | Songwriting | The Write Stuff Assistant" />
            <meta property="og:description" content="Create catchy melodies and unforgettable hooks. Our AI tool helps you explore melodic ideas, rhythms, and structures to make your songs stand out." />
            <meta property="og:url" content="https://writestuffassistant.com/melody-hook-creation" />
            <meta property="og:image" content="https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?q=80&w=2070&auto=format&fit=crop" />
            <meta property="og:image:alt" content="Musical notes on a sheet, representing melody and hook creation." />
        </Helmet>
    ...
    export default MelodyHookCreation;