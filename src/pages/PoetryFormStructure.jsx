...
const QUERY_TYPE = "poetry_form_structure";
const QUERY_TYPE_LABEL = "Form & Structure Selection";

function PoetryFormStructure({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/poetry-form-structure`} />
      </Helmet>
...
export default PoetryFormStructure;