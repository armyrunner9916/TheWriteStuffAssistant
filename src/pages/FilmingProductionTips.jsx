...
const QUERY_TYPE = "filming_production_tips";
const QUERY_TYPE_LABEL = "Filming & Production Tips";

function FilmingProductionTips({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/filming-production-tips`} />
      </Helmet>
...
export default FilmingProductionTips;