...
const QUERY_TYPE = "posting_optimization_growth";
const QUERY_TYPE_LABEL = "Posting, Optimization & Growth";

function PostingOptimizationGrowth({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/posting-optimization-growth`} />
      </Helmet>
      <div className="min-h-screen flex flex-col bg-black text-yellow-400">
        <header className="p-4 bg-black flex flex-col items-center gap-4 sticky top-0 z-10 border-b border-yellow-400/30">
          <div className="flex gap-2 flex-wrap justify-center items-center">
            <Button onClick={() => navigate('/online-content')} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400">
              <ArrowLeft className="h-4 w-4 mr-1" /> Back to Online Content
            </Button>
...
export default PostingOptimizationGrowth;