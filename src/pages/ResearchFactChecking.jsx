...
const QUERY_TYPE = "research_fact_checking";
const QUERY_TYPE_LABEL = "Research & Fact-Checking";

function ResearchFactChecking({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/research-fact-checking`} />
      </Helmet>
...
export default ResearchFactChecking;