...
const QUERY_TYPE = "scripting_storyboarding";
const QUERY_TYPE_LABEL = "Scripting & Storyboarding";

function ScriptingStoryboarding({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/scripting-storyboarding`} />
      </Helmet>
...
export default ScriptingStoryboarding;