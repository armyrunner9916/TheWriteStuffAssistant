...
const QUERY_TYPE = "audience_platform_strategy";
const QUERY_TYPE_LABEL = "Audience & Platform Strategy";

function AudiencePlatformStrategy({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/audience-platform-strategy`} />
      </Helmet>
...
export default AudiencePlatformStrategy;