import React, { useState, useEffect } from "react";
    ...
    const QUERY_TYPE = "theme_concept_development";
    const QUERY_TYPE_LABEL = "Theme & Concept Development"; // Changed from "Song Theme & Concept Development"

    function ThemeConceptDevelopment() {
      ...
      const handlePromptSubmit = async (promptText, file) => {
        ...
        try {
          ...
          toast({ title: "AI Response", description: "Theme/concept ideas generated." });
        } catch (error) {
          console.error("API Error:", error);
          toast({ title: "Error", description: error.message || "Failed to get ideas from AI.", variant: "destructive" });
        } finally {
          setIsLoading(false);
          setUploadedFile(null);
        }
      ...
      return (
        <>
        <Helmet>
            <title>Theme & Concept Development | The Write Stuff Assistant</title> {/* Changed title */}
            <meta name="description" content="Develop strong themes and concepts for your songs. Our AI tool helps you brainstorm ideas, explore emotions, and build a solid foundation for your lyrics." />
            <link rel="canonical" href="https://writestuffassistant.com/theme-concept-development" />
            <meta property="og:type" content="article" />
            <meta property="og:title" content="Theme & Concept Development | The Write Stuff Assistant" /> {/* Changed og:title */}
            <meta property="og:description" content="Develop strong themes and concepts for your songs. Our AI tool helps you brainstorm ideas, explore emotions, and build a solid foundation for your lyrics." />
            <meta property="og:url" content="https://writestuffassistant.com/theme-concept-development" />
            <meta property="og:image" content="https://images.unsplash.com/photo-1470225620780-dba8ba36b745?q=80&w=2070&auto=format&fit=crop" />
            <meta property="og:image:alt" content="A lightbulb glowing, symbolizing theme and concept development for songwriting." />
        </Helmet>
    ...
    export default ThemeConceptDevelopment;