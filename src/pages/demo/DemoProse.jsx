...
const SECTION_TITLE = "Fictional Prose Assistant (Demo)";
...
function DemoProse() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      trackDemoGeneration('prose', userPrompt);
  ...
  const handleFollowUp = async (e) => {
    ...
    try {
      ...
      trackDemoFollowUp('prose', followUp);
  ...
  return (
    <DemoLayout showBackButton={true}>
      <Helmet>
        <title>Fictional Prose Assistant Demo – The Write Stuff Assistant</title>
        <meta name="description" content="Try our fictional prose writing tools in demo mode. Create worlds, characters, outlines, and more - no signup required." />
        <meta name="robots" content="noindex,follow" />
        <link rel="canonical" href="https://writestuffassistant.com/demo/prose" />
      </Helmet>
      <div className="min-h-screen bg-black text-yellow-400 p-4 sm:p-6 flex flex-col items-center">
        <div className="w-full max-w-5xl lg:assistant-desktop-container">
          ...
          <p className="text-center text-yellow-400/80 mb-8">Try our modular tool for crafting compelling stories.</p>
          ...
          <div className="grid grid-cols-1 lg:assistant-desktop-grid gap-8">
            <Card className="bg-zinc-900/50 border-yellow-400/30 lg:assistant-control-panel">
              <CardHeader>
                <CardTitle className="text-yellow-400 text-2xl">Create Your Story Elements</CardTitle>
              </CardHeader>
              <CardContent>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mt-4 pt-4 border-t border-yellow-400/20">
                      ...
                      <form onSubmit={handleFollowUp} className="flex items-start gap-2 mt-2">
                        <Textarea 
                          ...
                          placeholder="e.g., Make the world description more dystopian..."
                          className="flex-grow"
                          minRows={1}
                        />
