...
const SECTION_TITLE = "Nonfiction Assistant (Demo)";
...
const fieldConfig = {
  ...
  outline: ["topic", "premise", "audience", "keyPoints", "lengthFormat"],
  voice_tone: ["topic", "audience", "toneStyle"],
  clarity: ["topic", "premise", "audience"],
  openings_conclusions: ["topic", "premise", "audience", "toneStyle"],
  all: ["topic", "researchQuestion", "premise", "audience", "toneStyle", "lengthFormat", "keyPoints"],
};

function DemoNonfiction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      trackDemoGeneration('nonfiction', userPrompt);

      toast({
        title: "Success!",
        description: `Your nonfiction content has been generated. ${getDemoQueriesRemaining()} queries remaining.`,
      });
    } catch (error) {
  ...
  const handleFollowUp = async (e) => {
    ...
    try {
      ...
      trackDemoFollowUp('nonfiction', followUp);
    ...
    <DemoLayout showBackButton={true}>
      ...
      <div className="min-h-screen bg-black text-yellow-400 p-4 sm:p-6 flex flex-col items-center">
        <div className="w-full max-w-5xl lg:assistant-desktop-container">
          ...
          <p className="text-center text-yellow-400/80 mb-8">Try our modular tool for crafting clear and compelling nonfiction.</p>
                   ...
                   <div className="flex-grow overflow-y-auto pr-4 space-y-4 lg:assistant-content-text">
                     {conversation.length > 0 ? (
                       ...
                       <div className="flex items-center justify-center h-full text-center text-yellow-400/60 p-8">
                         <p>Select an element to generate and your content will appear here.</p>
                       </div>
                     )}
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mt-4 pt-4 border-t border-yellow-400/20">
                      ...
                      <form onSubmit={handleFollowUp} className="flex items-start gap-2 mt-2">
                        <Textarea 
                          ...
                          placeholder="e.g., Can you provide more detail on the second key point?"
                          className="flex-grow"
                          minRows={1}
                        />
