...
function DemoSongwriting() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      trackDemoGeneration('songwriting', userPrompt);
  ...
  const handleFollowUp = async (e) => {
    ...
    try {
      ...
      trackDemoFollowUp('songwriting', followUp);
  ...
  return (
    <DemoLayout showBackButton={true}>
      <Helmet>
        <title>Songwriting Assistant Demo – The Write Stuff Assistant</title>
        <meta name="description" content="Try our songwriting tools in demo mode. Create lyrics, melodies, song structures, and more - no signup required." />
        <meta name="robots" content="noindex,follow" />
        <link rel="canonical" href="https://writestuffassistant.com/demo/songwriting" />
      </Helmet>
