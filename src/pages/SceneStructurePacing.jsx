...
const QUERY_TYPE = "scene_structure_pacing";
const QUERY_TYPE_LABEL = "Scene Structure & Pacing";

function SceneStructurePacing({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/scene-structure-pacing`} />
      </Helmet>
...
export default SceneStructurePacing;