...
const QUERY_TYPE = "poetry_rhyme_rhythm";
const QUERY_TYPE_LABEL = "Rhyme & Rhythm Assistant";

function PoetryRhymeRhythm({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/poetry-rhyme-rhythm`} />
      </Helmet>
...
export default PoetryRhymeRhythm;