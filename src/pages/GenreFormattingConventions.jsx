...
const QUERY_TYPE = "genre_formatting_conventions";
const QUERY_TYPE_LABEL = "Genre Formatting & Conventions";

function GenreFormattingConventions({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        <title>{QUERY_TYPE_LABEL} | The Write Stuff Assistant</title>
        <meta name="description" content={`AI-powered assistant for ${QUERY_TYPE_LABEL}.`} />
        <link rel="canonical" href={`https://writestuffassistant.com/genre-formatting-conventions`} />
      </Helmet>
      <div className="min-h-screen flex flex-col bg-black text-yellow-400">
        <header className="p-4 bg-black flex flex-col items-center gap-4 sticky top-0 z-10 border-b border-yellow-400/30">
          <div className="flex gap-2 flex-wrap justify-center items-center">
            <Button onClick={() => navigate('/stage-screen')} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400">
              <ArrowLeft className="h-4 w-4 mr-1" /> Back to Stage & Screen
            </Button>
...
export default GenreFormattingConventions;