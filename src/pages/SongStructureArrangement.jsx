import React, { useState, useEffect } from "react";
    ...
    const QUERY_TYPE = "song_structure_arrangement";
    const QUERY_TYPE_LABEL = "Song Structure & Arrangement";

    function SongStructureArrangement() {
      ...
      const handlePromptSubmit = async (promptText, file) => {
        ...
        try {
          ...
          toast({ title: "AI Response", description: "Structure suggestions generated." });
        } catch (error) {
      ...
      return (
        <>
        <Helmet>
            <title>Song Structure & Arrangement Tool | The Write Stuff Assistant</title>
            <meta name="description" content="Structure your songs for maximum impact. Our AI tool helps you arrange verses, choruses, and bridges to create a compelling musical journey." />
            <link rel="canonical" href="https://writestuffassistant.com/song-structure-arrangement" />
            <meta property="og:type" content="article" />
            <meta property="og:title" content="Song Structure & Arrangement Tool | The Write Stuff Assistant" />
            <meta property="og:description" content="Structure your songs for maximum impact. Our AI tool helps you arrange verses, choruses, and bridges to create a compelling musical journey." />
            <meta property="og:url" content="https://writestuffassistant.com/song-structure-arrangement" />
            <meta property="og:image" content="https://images.unsplash.com/photo-1619983081563-436f63e02242?q=80&w=2070&auto=format&fit=crop" />
            <meta property="og:image:alt" content="A music production setup with a keyboard and computer, symbolizing song structure and arrangement." />
        </Helmet>
    ...
    export default SongStructureArrangement;