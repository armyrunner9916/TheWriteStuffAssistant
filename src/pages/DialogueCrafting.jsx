...
const QUERY_TYPE = "dialogue_crafting";
const QUERY_TYPE_LABEL = "Dialogue Crafting";

function DialogueCrafting({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/dialogue-crafting`} />
      </Helmet>
...
export default DialogueCrafting;