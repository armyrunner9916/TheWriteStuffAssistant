...
const QUERY_TYPE = "organization_structure";
const QUERY_TYPE_LABEL = "Organization & Structure";

function OrganizationStructure({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        <title>Organization & Structure Tool | Nonfiction | The Write Stuff Assistant</title>
        <meta name="description" content="Structure your nonfiction work effectively. Use our tool to organize chapters, arguments, and narratives for maximum clarity and impact." />
        <link rel="canonical" href="https://writestuffassistant.com/organization-structure" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Organization & Structure Tool | Nonfiction | The Write Stuff Assistant" />
        <meta property="og:description" content="Structure your nonfiction work effectively. Use our tool to organize chapters, arguments, and narratives for maximum clarity and impact." />
        <meta property="og:url" content="https://writestuffassistant.com/organization-structure" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2070&auto=format&fit=crop" />
        <meta property="og:image:alt" content="A well-organized desk with notes and diagrams, symbolizing structure." />
      </Helmet>
      <div className="min-h-screen flex flex-col bg-black text-yellow-400">
        <header className="p-4 bg-black flex flex-col items-center gap-4 sticky top-0 z-10 border-b border-yellow-400/30">
          <div className="flex gap-2 flex-wrap justify-center items-center">
            <Button onClick={() => navigate('/nonfiction')} variant="outline" size="sm" className="bg-black text-yellow-400 hover:bg-zinc-800 border-yellow-400">
