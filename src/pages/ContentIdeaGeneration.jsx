...
const QUERY_TYPE = "content_idea_generation";
const QUERY_TYPE_LABEL = "Content Idea Generation";

function ContentIdeaGeneration({ onLogout }) {
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://writestuffassistant.com/content-idea-generation`} />
      </Helmet>
